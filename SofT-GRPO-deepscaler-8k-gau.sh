...
trainer.project_name='verl_soft-thinking-grpo_example_deepscaler_gau' \
...
trainer.default_local_dir=********************************/verl-save/verl_soft-thinking-grpo_deepscaler_gau/8k-train \
